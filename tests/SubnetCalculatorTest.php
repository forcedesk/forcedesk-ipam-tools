...
class SubnetCalculatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->sub = new IpamTools\SubnetCalculator('192.168.112.203', 23);
    }
    ...
    {
        // Given
        $sub = new IpamTools\SubnetCalculator($given_ip_address, $network_size);
    ...
    {
        // Given
        $sub = new IpamTools\SubnetCalculator($ip_address, $given_network_size);
    ...
    {
        // Given
        $sub = new IpamTools\SubnetCalculator($ip_address, 24);
    ...
    {
        // Given
        $sub = new IpamTools\SubnetCalculator($ip_address, $network_size);
    ...
    {
        // Given
        $sub = new IpamTools\SubnetCalculator('192.168.233.207', $network_size);
    ...
    {
        // Given
        $validateInputs = new \ReflectionMethod(IpamTools\SubnetCalculator::class, 'validateInputs');
    ...
    public function testConstructorExceptionOnBadNetworkSize(int $network_size): void
    {
        ...
        // When
        $sub = new IpamTools\SubnetCalculator('192.168.112.203', $network_size);
    }
    ...
    public function testGetSubnetJsonReportJsonError(): void
    {
        ...
        $subnetReport = $this->getMockBuilder(IpamTools\SubnetReport::class)
            ->onlyMethods(['createJsonReport'])
            ->getMock();
        $subnetReport->method('createJsonReport')->willReturn(false);

        /** @var IpamTools\SubnetReport $subnetReport */
        $sub = new IpamTools\SubnetCalculator('192.168.112.203', 23, $subnetReport);
    ...
    {
        // Given
        $sub   = new IpamTools\SubnetCalculator('192.168.112.203', 32);
        $count = 0;
    ...
    public function testGetAllIPAddressesIPRangeCalculationError(): void
    {
        ...
        $sub = $this->getMockBuilder(IpamTools\SubnetCalculator::class)
            ->onlyMethods(['getIPAddressRange'])
            ->disableOriginalConstructor()
            ->getMock();
        $sub->method('getIPAddressRange')->willReturn(['-4', '-1']);
        /** @var IpamTools\SubnetCalculator $sub */
    ...
    {
        // Given
        $subnet = new IpamTools\SubnetCalculator($ipAddress, 24);
